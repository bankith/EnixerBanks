...
namespace EnixerBanks.PayBills2
{
    public partial class PaybillAmountPage : ContentPage
    {
        ...
        protected override void OnAppearing()
        {
            ...
            currytext.Text = user.Currency;

            MoneyLable.Text = user.AvailableBalance.ToString() + " " + user.Currency + " Avaliable";
        ...
        private async void NEXT_Clicked(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (INTnumPin > user.AvailableBalance)
                {
                ...
                await Navigation.PushAsync(new PayBills2.Transfer2ndPage(numPin, Reftext, cardSelected, user));
            }
