        ...
        private async void numberPinAsync(int v)
        {
            ...
            if (countClick < 6)
            {
                ...
                if (countClick == 6)
                {
                    ...
                    if (user != null)
                    {
                        await Navigation.PushAsync(new ExistingUserLoginView.ConfirmPinPage(FirstTimePin, user));
                    }
                    else
                    {
                        await Navigation.PushAsync(new ExistingUserLoginView.ConfirmPinPage(FirstTimePin));
                    }
